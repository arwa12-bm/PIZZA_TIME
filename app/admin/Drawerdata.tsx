...
const Data:React.FC<DataProps> = ({
    ...
    return (
        ...
        <p onClick={()=>handleShop()} className={!addshop?'border-b-[1px] py-8 text-lg text-center text-slate-500  transition hover:scale-105 cursor-pointer':'border-b-[2px] border-b-slate-700  py-8  text-lg text-center text-slate-500  transition hover:scale-105 cursor-pointer'}>Gérer les boutiques</p>
